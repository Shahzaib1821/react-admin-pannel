...
function SupportPage() {
  const [queries, setQueries] = useState([
    { id: 1, user: 'John Doe', query: 'How can I reset my password?', answer: '' },
    { id: 2, user: 'Jane Smith', query: 'What are the shipping charges?', answer: '' },
    { id: 3, user: 'Jim Brown', query: 'How do I update my profile?', answer: '' },
  ]);
