...
function AccountancyPage() {
  const [queries, setQueries] = useState([
    { id: 1, user: 'John Doe', query: 'How do I reconcile my bank statement?', answer: '' },
    { id: 2, user: 'Jane Smith', query: 'What is the difference between accrual and cash basis accounting?', answer: '' },
    { id: 3, user: 'Jim Brown', query: 'Can you explain depreciation methods?', answer: '' },
  ]);
  ...
  return (
    <GeneralLayout>
      <div className="max-w-lg mx-auto mt-10 p-6 bg-white rounded-lg shadow-md">
        <h1 className="text-2xl font-bold mb-6">Accountancy Queries</h1>
